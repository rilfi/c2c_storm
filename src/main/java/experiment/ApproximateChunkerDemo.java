...
public class ApproximateChunkerDemo {
    ...
    public static void main(String[] args) {
        DictionaryEntry<String> entry1
            = new DictionaryEntry<String>("study", "P53");
...
String text="A protein called 53 Mdm2 binds to p53 and transports going it studying from the nucleus to the cytosol.";
