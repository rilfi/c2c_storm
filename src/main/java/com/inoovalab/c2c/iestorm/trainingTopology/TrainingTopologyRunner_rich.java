...
public class TrainingTopologyRunner_rich {
  public static void main(String[] args) throws InvalidTopologyException, AuthorizationException, AlreadyAliveException {
    ...
    builder.setBolt("tokenizing_rich_Bolt", new tokenizing_rich_Bolt(), 100).shuffleGrouping("File_rich_Spout");
    builder.setBolt("Brand_rich_Bolt", new Brand_rich_Bolt(), 150).shuffleGrouping("tokenizing_rich_Bolt");
    builder.setBolt("catogory_rich_Bolt", new catogory_rich_Bolt(), 150).shuffleGrouping("Brand_rich_Bolt");
